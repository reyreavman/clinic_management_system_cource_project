...
public record NewClientPayload(
        ...
        @Size(min = 1, max = 50, message = "{clinic.clients.create.errors.firstName_size_is_invalid}")
        String firstName,
        ...
        @Size(min = 1, max = 20, message = "{clinic.clients.create.errors.phoneNumber_size_is_invalid}")
        String phoneNumber,

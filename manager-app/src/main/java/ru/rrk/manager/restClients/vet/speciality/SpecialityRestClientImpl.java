...
public class SpecialityRestClientImpl implements SpecialityRestClient {
    ...
    public List<Speciality> findAllSpecialities(String filter) {
        return this.client
                .get()
                .uri("/clinic-api/vets/specialities?filter={filter}", filter)
                .retrieve()
    ...
    public Speciality createSpeciality(String name) {
        try {
            return this.client
                    .post()
                    .uri("/clinic-api/vets/specialities")
    ...
    public Optional<Speciality> findSpeciality(int specialityId) {
        try {
            return Optional.ofNullable(this.client.get().uri("/clinic-api/vets/specialities/{specialityId}", specialityId).retrieve().body(Speciality.class));
    ...
    public void updateSpeciality(int specialityId, String name) {
        try {
            this.client.patch().uri("/clinic-api/vets/specialities/{specialityId}", specialityId).contentType(MediaType.APPLICATION_JSON).body(new UpdateSpecialityPayload(name)).retrieve().toBodilessEntity();
        } catch (HttpClientErrorException.BadRequest exception) {
    ...
    public void deleteSpeciality(int specialityId) {
        try {
            this.client
                    .delete()
                    .uri("/clinic-api/vets/specialities/{specialityId}", specialityId)
                    .retrieve()
                    .toBodilessEntity();
        } catch (HttpClientErrorException.NotFound exception) {
